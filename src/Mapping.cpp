...
Transporter recognizeTargetObjects(vector<Object> mfis, vector<Object> po_pv, vector<Object> pobjects_cv, vector<double> ctda, int viewNumber)
{
...
vector<double> findBoundariesOfCV(vector<Object> casr) 
{
    ...
    result.push_back(leftBoundary);
    result.push_back(rightBoundary);
    result.push_back(frontBoundary);
...
void keyInfoOfCompuetedPM(char *mappingInfoFileName, int ASRNumber, vector<int> exitPoints, vector<int> lostPoints,
    ...
    //cout << endl << " times. Visual Triangulation updating: " << << " times. Path Integration updating: " << << endl;
    cout << "Lost Point: ";
...
/*
   ...
   // plotObjectsOf3Kinds("Maps/PointToHome.png", MFIS, currentRobotPosition, currentRobotPositionInMFIS);
